...
# import speech_recognition  # for exception handling

# from agent import process_query
# import db
# from voice.speech_to_text import record_and_transcribe
# from voice.text_to_speech import speak_text

# # --- Configure Google API using Streamlit Secrets ---
# genai.configure(api_key=st.secrets["GOOGLE_API_KEY"])
# model = genai.GenerativeModel("gemini-1.5-flash")

# # --- Setup DB and Load Existing Data ---
# db.create_tables()
